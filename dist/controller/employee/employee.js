...
exports.getEmployeesWithoutUserProfiles = exports.getEmployeeDetails = exports.searchEmployeeByPhone = exports.searchEmployeeByName = exports.deleteEmployee = exports.updateEmployee = exports.getEmployeeUsers = exports.createEmployee = void 0;
const client_1 = require("@prisma/client");
const userManagement_1 = require("../userManagement/userManagement");
const sms_1 = require("../sms/sms");
const prisma = new client_1.PrismaClient();
const createEmployee = async (req, res) => {
    const { organizationId, phoneNumber, idNumber, grossSalary, firstName, lastName, jobId, secondaryPhoneNumber } = req.body;
    ...
    try {
        ...
        if (role.includes('ORG_ADMIN')) {
            const userOrgId = await (0, userManagement_1.getUserOrganizationIdById)(userId);
        ...
        await (0, sms_1.sendSMS)(tenantId, phoneNumber, welcomeMessage);
...
exports.getEmployeeUsers = getEmployeeUsers;
const getEmployeesWithoutUserProfiles = async (req, res) => {
    const tenantId = req.user?.tenantId;
    if (!tenantId) {
        res.status(400).json({
            success: false,
...
exports.getEmployeesWithoutUserProfiles = getEmployeesWithoutUserProfiles;
...
exports.searchEmployeeByName = searchEmployeeByName;
// Search Employee by Phone
const searchEmployeeByPhone = async (req, res) => {
    try {
        const tenantId = req.user?.tenantId;
...
exports.searchEmployeeByPhone = searchEmployeeByPhone;

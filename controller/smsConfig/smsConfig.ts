...
import { APIResponse, SMSConfig } from '../../types/sms';
...
// Update SMSConfig
const updateSMSConfig = async (req: AuthenticatedRequest, res: Response<APIResponse> ): Promise<void> => {
...
// Create SMSConfig
const createSMSConfig = async (req: AuthenticatedRequest, res: Response<APIResponse>): Promise<void> => {
  const { tenantId } = req.user!; // Extract tenantId from authenticated user
...
export { updateSMSConfig, createSMSConfig };